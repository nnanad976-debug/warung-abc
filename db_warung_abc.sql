...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2026 at 06:24 AM
...
--
-- Table structure for table `tbl_userr`
--
...
--
-- Dumping data for table `tbl_userr`
--

INSERT INTO `tbl_userr` (`id_user`, `nama_lengkap`, `username`, `password`, `role`) VALUES
(1, 'Adminstrator', 'admin', '$2y$10$umdtqoVPvuPc.Pk/MhYfnucHSKpPWPr3Xrw2GnFSd9LltRjmLYEA.', 'admin');
...
--
-- Indexes for table `tbl_userr`
--
ALTER TABLE `tbl_userr`
...
--
-- AUTO_INCREMENT for table `tbl_userr`
--
ALTER TABLE `tbl_userr`
...
--
ALTER TABLE `tbl_log`
  ADD CONSTRAINT `tbl_log_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `tbl_userr` (`id_user`);

--
-- Constraints for table `tbl_transaksi`
--
ALTER TABLE `tbl_transaksi`
  ADD CONSTRAINT `tbl_transaksi_ibfk_1` FOREIGN KEY (`id_kasir`) REFERENCES `tbl_userr` (`id_user`),
